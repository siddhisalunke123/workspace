...
{
string constr = "User ID=sa;password=examlyMssql@123; server=localhost;Database=siddhidb;trusted_connection=false;Persist Security Info=False;Encrypt=False";
